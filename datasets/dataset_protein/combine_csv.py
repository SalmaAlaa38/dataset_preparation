...
folder_path = r"D:\dataset_preprocessing\datasets\dataset_protein"
...
combined_data.to_csv("tagged_recipes_by_protein.csv", index=False)
...
tagged_combined_data.to_csv("combined_tagged_recipes_by_protein.csv", index=False)
